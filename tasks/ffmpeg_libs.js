...
function getFFMPEG(platform, arch, dir, callback) {

    utils.getJson('https://api.github.com/repos/Magics-Group/ffmpeg-prebuilt/releases/latest')
        .then(function(json) {

            if (json.message === 'Not Found') {
                console.log('No FFMPEG Download Found');
                return callback();
            }
            var candidate = false;
            ...
            if (!candidate) {
                console.log('No FMPEG Download Found');
                return callback();
            }
    ...
    function downloadTask() {
        ...
        if (params.force)
            rimraf(params.dir, function() {
                getFFMPEG(params.platform, params.arch, params.dir, done);
            });
        else {
            getFFMPEG(params.platform, params.arch, params.dir, done);
        }
